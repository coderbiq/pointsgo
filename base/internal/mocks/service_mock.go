...
// Source: github.com/coderbiq/pointsgo/base/internal/service (interfaces: Infra,AppServices,RegisterService,DepositService,ConsumeService,AccountFinder)
...
func (m *MockAppServices) Finder() service.AccountFinder {
	ret := m.ctrl.Call(m, "Finder")
	ret0, _ := ret[0].(service.AccountFinder)
	return ret0
}
