...
// Source: github.com/coderbiq/pointsgo/base (interfaces: AppServices,Infra,RegisterService,DepositService,ConsumeService,AccountRepository)
...
func (m *MockAppServices) ConsumeApp() base.ConsumeService {
	ret := m.ctrl.Call(m, "ConsumeApp")
	ret0, _ := ret[0].(base.ConsumeService)
	return ret0
}
...
func (m *MockAppServices) DepositApp() base.DepositService {
	ret := m.ctrl.Call(m, "DepositApp")
	ret0, _ := ret[0].(base.DepositService)
	return ret0
}
...
func (m *MockAppServices) RegisterApp() base.RegisterService {
	ret := m.ctrl.Call(m, "RegisterApp")
	ret0, _ := ret[0].(base.RegisterService)
	return ret0
}
...
func (m *MockInfra) AccountRepo() base.AccountRepository {
	ret := m.ctrl.Call(m, "AccountRepo")
	ret0, _ := ret[0].(base.AccountRepository)
	return ret0
}
...
func (m *MockAccountRepository) Save(arg0 base.Account) error {
